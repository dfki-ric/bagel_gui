...
namespace bagel_gui {
  ...
  public:
    ...
    std::map<unsigned long, std::vector<std::string> > getCompatiblePorts(unsigned long nodeId, const std::string& outPortName) override {return std::map<unsigned long, std::vector<std::string> >();}
